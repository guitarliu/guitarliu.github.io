...
- 工作内容及成果：
  - :pushpin: 协调各专业BIM建模内容及建模思路
  - :pushpin: 收集并解决各专业建模过程遇到的技术问题
  - :pushpin: 完成现状桥梁桥墩族建模及布置、下穿通道及其两侧挡墙、边沟建模
  - :pushpin: 现场勘查项目范围内重要设备或构筑物(如发射塔及其防护挡墙)，并最终反映至模型
  - :pushpin: 合并各专业模型并完成视频渲染及[***360全景***](https://720yun.com/vr/b5621ai8jus "金山大桥慢行系统改造工程720云全景图")
...
- 工作内容及成果: 
  - :triangular_flag_on_post: 完成龙山十路综合管廊十字节点、T型交叉节点建模
